...
- Execute the Get method on the UserPostController via Swagger to see the results in development.  
- Run the unit tests to assert the caching layer is working.
- Run the application in production with a URL of / to see the default endpoint emit the json data.
